...
| **ThemeProvider** | `components/theme/ThemeProvider.tsx` | Thin wrapper over `next-themes` | `children: ReactNode` | Must be ancestor of any `useTheme()` consumer | system (default), light, dark | D13, D19 |
